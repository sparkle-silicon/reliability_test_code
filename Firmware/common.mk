...
O_OBJS 			:= $(O_SRCS)
LINK_LIBS 		:= $(LINK_LIBS)
CLEAN_OBJS		+= $(ASM_IBJS) $(ASM_DBJS) $(ASM_OBJS)  $(C_IBJS) $(C_SBJS) $(C_DBJS)  $(C_OBJS) $(ASM_ASMBJS)
# Double Boot config
...
CLEAN_OBJS		+= $(ASM_IBJS1) $(ASM_DBJS1) $(ASM_OBJS1)  $(C_IBJS1) $(C_SBJS1) $(C_DBJS1)  $(C_OBJS1) $(ASM_ASMBJS1)
# 定义辅引导编译选项
ASM_IBJS2 			:= $(ASM_SRCS:.S=2.i)
ASM_DBJS2 		    := $(ASM_SRCS:.S=2.d)
ASM_OBJS2			:= $(ASM_SRCS:.S=2.o)
ASM_ASMBJS2 		:= $(ASM_SRCS:.S=2.asm)
...
CLEAN_OBJS		+= $(ASM_IBJS2) $(ASM_DBJS2) $(ASM_OBJS2)  $(C_IBJS2) $(C_SBJS2) $(C_DBJS2)  $(C_OBJS2) $(ASM_ASMBJS2)
endif
ifeq ($(OS),Linux) #Linux
