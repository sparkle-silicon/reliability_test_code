...
int32_t SYSCTL_PIOA_IECFG_CONTEXT = 0;
int32_t SYSCTL_PIOB_IECFG_CONTEXT = 0;
int32_t SYSCTL_PIOCD_IECFG_CONTEXT = 0;
int32_t SYSCTL_PIOE_IECFG_CONTEXT = 0;
int32_t SYSCTL_SLEEPCFG_CONTEXT = 0;
int32_t SYSCTL_CLKDIV_OSC96M_CONTEXT = 0;
int32_t SYSCTL_PECI_PAD_CTRL_CONTEXT = 0;
...
void ALIGNED(4) OPTIMIZE(0) CPU_SLP_RES(void)
{
	...
	//flash pin
	SYSCTL_PIOB_IECFG = 0x0;//外部spif pin
	SYSCTL_PIOE_IECFG &= 0x00ffffff;//内部spif pin
	//SYSCTL_PIO3_CFG = 0x0;
	//dvdd
	...
	SYSCTL_PIOA_IECFG = SYSCTL_PIOA_IECFG_CONTEXT;
	SYSCTL_PIOB_IECFG = SYSCTL_PIOB_IECFG_CONTEXT;
	SYSCTL_PIOCD_IECFG = SYSCTL_PIOCD_IECFG_CONTEXT;
	SYSCTL_PIOE_IECFG = SYSCTL_PIOE_IECFG_CONTEXT;
	SYSCTL_CLKDIV_OSC96M = SYSCTL_CLKDIV_OSC96M_CONTEXT;
	SYSCTL_SLEEPCFG = SYSCTL_SLEEPCFG_CONTEXT;
	SYSCTL_PECI_PAD_CTRL = SYSCTL_PECI_PAD_CTRL_CONTEXT;
...
void Save_Context(void)
{
	...
	SYSCTL_PIOA_IECFG_CONTEXT = SYSCTL_PIOA_IECFG;
	SYSCTL_PIOB_IECFG_CONTEXT = SYSCTL_PIOB_IECFG;
	SYSCTL_PIOCD_IECFG_CONTEXT = SYSCTL_PIOCD_IECFG;
	SYSCTL_PIOE_IECFG_CONTEXT = SYSCTL_PIOE_IECFG;
	SYSCTL_SLEEPCFG_CONTEXT = SYSCTL_SLEEPCFG;
	SYSCTL_CLKDIV_OSC96M_CONTEXT = SYSCTL_CLKDIV_OSC96M;//降频3M
	SYSCTL_PECI_PAD_CTRL_CONTEXT = SYSCTL_PECI_PAD_CTRL;
...
void CHIP_Sleep(void)
{
	...
	//SYSCTL_PIOB_IECFG = 0x00f00000;//外部spif pin
...
#endif
	SYSCTL_PIOE_IECFG = 0xffff0000;
#else
	SYSCTL_PIO5_CFG = 0;
	SYSCTL_PIO1_CFG = 0;
	SYSCTL_PIOE_IECFG = 0xff000000;//内部flash pin
#endif
	SYSCTL_PIO0_CFG = 0;
	SYSCTL_PIO2_CFG = 0;
...
void CHIP_Deep_Sleep(void)
{
	...
	SYSCTL_SLEEPCFG = (0x1 << 5) | (0x1 << 3) | (0x1 << 1);
	//io mux
#if SUPPORT_KBS_WAKEUP
	SYSCTL_PIO5_CFG &= 0xfffc0000;
#if (KBD_8_n_SWITCH == 16)
...
void CHIP_Deep_Sleep2(void)
{
	...
	*(volatile uint32_t*)(0x30510) = 0x1eff;
	...
	// SYSCTL_PIO1_CFG = 0x0;
	// SYSCTL_RST1 |= 0x1<<16;
	SYSCTL_PIOA_IECFG = 0xffffffff;
	SYSCTL_PIOB_IECFG = 0xffffffff;
	SYSCTL_PIOCD_IECFG = 0xffffffff;
